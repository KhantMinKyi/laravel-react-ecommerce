...
@section('content')
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <a href="{{ route('admin.create-product-add', $product->slug) }}" class="btn btn-sm btn-dark">Add Transaction</a>
        </div>
    ...
    <div>
        <form action="{{ route('admin.create-product-remove', $product->slug) }}" method="POST">
            @csrf
